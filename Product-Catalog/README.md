## Product Catalog Service Application Deployment on AWS EKS using AWS EKS, ArgoCD and Terraform
...
## Application Code
The `src` directory contains the source code for the TProduct Catalog Web Application. Dive into this directory to explore the frontend and backend implementations.
...
📈 **The journey covered everything from setting up tools to deploying a Product Catalog Service app, ensuring data persistence, and implementing CI/CD pipelines.**
